...
public class WOLiOSautomation {
	...
	public void beforeMethod() throws Exception { //setup		 
	  ...
	  private void waitForVisible(By xpath, int i) {
	...
	List<WebElement> mTextField = driver.findElements(By.xpath("//UIAApplication[1]/UIAWindow[1]/UIAScrollView[2]/UIAWebView[1]/UIATextField"));	 	
	List<WebElement> mSecureTextField = driver.findElements(By.xpath("//UIAApplication[1]/UIAWindow[1]/UIAScrollView[2]/UIAWebView[1]/UIASecureTextField"));
	List<WebElement> mButton = driver.findElements(By.xpath("//UIAApplication[1]/UIAWindow[1]/UIAScrollView[2]/UIAWebView[1]/UIAButton"));		 				  				  
	...
	completeList.addAll(mTextField);
	completeList.addAll(mSecureTextField);
	completeList.addAll(mButton);
							...
							System.out.println("\nLogin with");
		 	            	driver.context("NATIVE_APP");
		 					 ...
		 					 { 				
		 						 ...
		 						 driver.findElement(By.className("UIATextField")).sendKeys("Nuvoxdemo1");
		 					
		 						 driver.findElement(By.className("UIASecureTextField")).click();
		 						 
		 						 driver.findElement(By.className("UIASecureTextField")).sendKeys("Custtest1");
