...
/**	 * This is a utility class created to read the excel test data file before performing the test steps.
    ...
    public class ExcelReader {	
    	 ...
    	 public static Sheet wrksheet;                                                      //*** The worksheet to read in Excel file  
    	 public static Workbook wrkbook = null;                                             // ***The Excel file to read
    	 public static Hashtable<String, Integer> dict = new Hashtable<String, Integer>();  //***Store the column data
